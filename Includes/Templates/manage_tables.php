...
<div class="gswpts_manage_table_container">
        ...
        <div class="container mt-4 manage_table_content transition hidden">
            ...
            <div class="row">
                ...
                <div class="col-12 p-0 gswpts_modal d-flex justify-content-center align-items-center transition hidden">
                ...
                <div id="gswpts_tables_container" class="col-12 p-0 position-relative">
