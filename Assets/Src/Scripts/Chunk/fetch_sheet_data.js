                    ...
                    if (JSON.parse(res.responseText).response_type == "success") {
                        ...
                        setTimeout(() => {
                            ...
                            if (!this.isProPluginActive()) {
                                this.call_alert(
                                    "Warning &#9888;&#65039;",
                                    "<b>Live sync is limited to 50 rows in free version.<br/><a target='blank' href='https://wppool.dev/sheets-to-wp-table-live-sync/'>Upgrade to Pro</a> for showing full google sheet.</b>",
                                    "warning",
                                    10
                                );
                            }
