    ...
    edit: ({ attributes, setAttributes }) => {
        ...
        function update_default_attibutes(ajax_table_settings) {
            ...
            prevSettingObj.showInfoBlock =
                ajax_table_settings.show_info_block == "true" ? true : false;
            prevSettingObj.responsiveTable =
                ajax_table_settings.responsive_table == "true" ? true : false;
            prevSettingObj.showXEntries =
                ajax_table_settings.show_x_entries == "true" ? true : false;
            ...
            prevSettingObj.allowSorting =
                ajax_table_settings.allow_sorting == "true" ? true : false;
                                ...
                                <PanelRow>
                                    <div class="default_rows">
                                        ...
                                        <Dropdown
                                            ...
                                            defaultValue={
                                                attributes.table_settings.defaultRowsPerPage
                                            }
                                            fluid
                                            selection
                                            options={[
